...
<style scoped>
.data-display { max-width: 1440px; margin: 0 auto; }.page-header { margin-bottom: 24px; }.page-header h2 { font-size: 26px; }.page-header h2::after { content: 'LIVE TELEMETRY BOARD'; display: block; margin-top: 5px; color: var(--color-cyan); font: 10px/1 'Roboto Mono', monospace; letter-spacing: .14em; }.page-header p { margin-top: 10px; color: var(--text-secondary); }.stat-row { margin-bottom: 12px; }.stat-card { min-height: 94px; padding: 16px; border-radius: 8px; box-shadow: none; }.stat-card:hover { transform: none; box-shadow: none; background: var(--bg-hover); }.stat-icon-box { width: 36px; height: 36px; border-radius: 6px; }.stat-value { font-family: 'Roboto Mono', monospace; }.filter-bar { border-radius: 8px; margin-bottom: 12px; }.device-gauge-card { border-radius: 8px; border-top-width: 2px; }.card-header { background: var(--bg-secondary); }.live-badge, .gauge-tag { border-radius: 4px; font-family: 'Roboto Mono', monospace; }.gauge-circle { width: 112px; height: 112px; }.gauge-inner { background: var(--bg-card); }.gauge-value { font-family: 'Roboto Mono', monospace; }
@media (max-width: 900px) { .stat-row :deep(.el-col) { width: 50%; max-width: 50%; flex: 0 0 50%; margin-bottom: 10px; }.filter-bar { align-items: flex-start; flex-direction: column; }.filter-left, .filter-right { flex-wrap: wrap; } }
@media (max-width: 560px) { .page-header { display: block; }.header-actions { margin-top: 14px; }.stat-row :deep(.el-col) { width: 100%; max-width: 100%; flex: 0 0 100%; }.filter-left, .filter-right { width: 100%; }.filter-left :deep(.el-select) { width: 100% !important; }.card-header { align-items: flex-start; gap: 10px; }.card-header-right { align-items: flex-end; flex-direction: column; }.gauge-row { gap: 20px; padding: 20px 14px; } }
</style>
