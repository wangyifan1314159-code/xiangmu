...
<style scoped>
.tcp-connections { max-width: 1440px; margin: 0 auto; }.page-header { margin-bottom: 24px; }.page-header h2 { font-size: 26px; }.page-header h2::after { content: 'DEVICE GATEWAY / TCP'; display: block; margin-top: 5px; color: var(--color-cyan); font: 10px/1 'Roboto Mono', monospace; letter-spacing: .14em; }.page-header p { margin-top: 10px; color: var(--text-secondary); }.stat-row { margin-bottom: 12px; }.stat-card { border-radius: 8px; box-shadow: none; }.stat-icon { width: 38px; height: 38px; border-radius: 6px; }.stat-icon.online { background: rgba(34,197,94,.12); color: var(--color-success); }.stat-icon.total { background: var(--color-primary-soft); color: var(--color-primary); }.stat-value { color: var(--text-primary); font-family: 'Roboto Mono', monospace; }.table-card { border-color: var(--border-color); box-shadow: none; }.card-header > span { color: var(--text-primary); font-weight: 600; }.device-id, .device-chip { color: var(--text-primary); font-family: 'Roboto Mono', monospace; }.online-dot { background: var(--color-success); box-shadow: 0 0 0 3px rgba(34,197,94,.12); }
@media (max-width: 760px) { .stat-row :deep(.el-col) { width: 100%; max-width: 100%; flex: 0 0 100%; margin-bottom: 10px; }.table-card { overflow-x: auto; } }
</style>
