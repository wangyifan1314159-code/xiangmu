...
<style scoped>
.data-center { max-width: 1440px; margin: 0 auto; }.page-header { margin-bottom: 24px; }.page-header h2 { font-size: 26px; }.page-header h2::after { content: 'HISTORICAL DATA QUERY'; display: block; margin-top: 5px; color: var(--color-cyan); font: 10px/1 'Roboto Mono', monospace; letter-spacing: .14em; }.page-header p { margin-top: 10px; color: var(--text-secondary); }.data-center :deep(.el-card) { border-radius: 8px; }.search-bar { padding: 14px; border: 1px solid var(--border-color); border-radius: 7px; background: var(--bg-secondary); }.search-bar :deep(.el-input__wrapper), .search-bar :deep(.el-select__wrapper) { background: var(--bg-card); box-shadow: 0 0 0 1px var(--border-color) inset !important; }.pagination { padding-top: 4px; border-top: 1px solid var(--border-light); }
@media (max-width: 760px) { .search-bar > * { width: 100% !important; }.search-bar :deep(.el-button-group) { display: grid; grid-template-columns: repeat(4, 1fr); }.pagination { justify-content: center; overflow-x: auto; } }
</style>
