...
/* Industrial access surface: retain the existing authentication flow, remove decorative motion. */
.bg-canvas { display: none; }
.login-page { padding: 24px; background: var(--bg-primary); }
.login-container { width: min(960px, 100%); min-height: 560px; border: 1px solid var(--border-color); border-radius: 8px; box-shadow: 0 20px 48px rgba(0,0,0,.25); backdrop-filter: none; }
.login-left { background: var(--bg-secondary); border-right: 1px solid var(--border-color); }.login-left::before { display: none; }.login-right { background: var(--bg-card); border: 0; backdrop-filter: none; }.title-iot, .title-cloud { color: var(--text-primary); -webkit-text-fill-color: var(--text-primary); background: none; }.brand-subtitle, .feature-desc, .form-header p, .form-footer { color: var(--text-secondary); }.feature-item { border-color: var(--border-color); border-radius: 6px; background: var(--bg-card); }.feature-item:hover { transform: none; background: var(--bg-hover); border-color: var(--color-primary); }.feature-icon, .form-avatar { border-radius: 6px; color: var(--color-primary); background: var(--color-primary-soft); border-color: rgba(22,119,255,.35); }.iot-visual { transform: scale(.82); }.outer-ring, .middle-ring { animation: none; border-color: var(--border-color); }.ring-node { display: none; }.core-icon { border-radius: 6px; animation: none; color: var(--color-primary); background: var(--color-primary-soft); border-color: rgba(22,119,255,.35); box-shadow: none; }.custom-input :deep(.el-input__wrapper) { border-radius: 6px; background: var(--bg-secondary); border-color: var(--border-color); }.custom-input :deep(.el-input__wrapper.is-focus) { border-color: var(--color-primary); background: var(--bg-secondary); box-shadow: 0 0 0 2px rgba(22,119,255,.14); }.login-btn, .phone-login-btn { border-radius: 6px; background: var(--color-primary); }.login-btn:hover, .phone-login-btn:hover { transform: none; box-shadow: none; }.login-btn::before { display: none; }.register-link, .register-link:hover { color: var(--color-primary) !important; }
</style>
